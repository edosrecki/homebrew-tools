class GoogleCloudSql < Formula
  ...
  url "https://github.com/edosrecki/google-cloud-sql-cli/releases/download/v1.9.0/google-cloud-sql-macos-1.9.0.tar.gz"
  sha256 "d2f12c90a0ea8aaf6ca8f47b3d24c1443de879cfb04d569f4fadfa5eb0126f4a"
  def install
